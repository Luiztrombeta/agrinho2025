/*  Prova 1 - Lógica de Programação
    Desenvolvimento das telas de menu
    
    Link do vídeo no Drive:https://drive.google.com/file/d/1-bKEUJp7eLdwpbDKZ9NaFNAzIVnOq03l/view?usp=sharing
    
    Link do vídeo no Youtube:https://youtu.be/79cNPG1o01c
...
var questaodois= "como podemos reescrever o numero 91 através da subtraçao? "
var questaotres= "como podemos reescrever o numero 25 através da divisão?"
var questaoquatro = "como podemos reescrever o numero 49 através da multiplicação?"
var questaocinco="em uma expressao numerica qual a prioridade entre as operações"
var questaoseis = "qual o resutado da expressao numerica 1+3*4*2+7"
var questaosete = "qual o resultado da expressao numerica 1 - 7*3+2*7+1+3-4/2"
var questaooito = "resolva a expressão numérica 2*12/4-4+4-8*7*9+3*8"
var questaonove = "resolva a expressão numérica 7*6*3*10*5*3*8*9*0*3"
...
function setup() {
  ...
  plano =  loadImage('planob.jpg')
   ...
   gucci1=loadImage('r1.png')
   gucci2=loadImage('r2.png')
   gucci3=loadImage('r3.png')
   gucci4=loadImage('r4.png')
   gucci5=loadImage('r5.png')
   gucci6=loadImage('r6.png')
   boneco[0]=loadImage('b1.png')
  boneco[1]=loadImage('b2.png')
  boneco[2]=loadImage('b3.png')
  boneco[3]=loadImage('b4.png')
  boneco[4]=loadImage('b5.png')
  boneco[5]=loadImage('b6.png')
}
...
function draw() {
  ...
  if (tela == 1) {
    ...
    if (controledomouse == false) {
      ...
      text('instruçoes', 130, 200);
      text('creditos', 130, 270);
...
fase=8
  ...
  // iniciando a tela 12 depois do botao da questao 8
    ...
    if (controledomouse == false && tecla==false) {
     ...
     imageMode(CENTER)
       image(gucci1,gucci1X,gucci1Y,w,p);
       image(gucci2,gucci2X,gucci2Y,w,p);
       image(gucci3,gucci3X,gucci3Y,w-60,p);
    ...
    if (controledomouse == false && tecla==false) {
     ...
     fill(240)
      ...
      stroke(cor)
       rect(140, 260, w+10, p+10)
       imageMode(CENTER)
       image(gucci4,gucci4X,gucci4Y,w-40,p);
       image(gucci5,gucci5X,gucci5Y,w-40,p);
       image(gucci6,gucci6X,gucci6Y,w,p);
...
// iniciando a tela carregando
 ...
 if(fasea==1 ){tela=5 
                   tecla= true
                  botao=11} 
        else if(fasea==2 ){tela=6
                tecla = true
                         botao=14}
        else if(fasea==3 ){tela=7
                tecla = true
                         botao=17}
           else if(fasea==4 ){tela=8 
                tecla = true
                            botao=20}
           else if(fasea==5 ){tela=9
                tecla= true }
           else if(fasea==5+1 ){tela=10 
                tecla = true
                              botao=23}
           else if(fasea==5+2 ){tela=11 
                tecla = true
                              botao=26}
           else if(fasea==5+3 ){tela=12 
                tecla = true }
           else if(fasea==5+4 ){tela=12+1 
                tecla = true }
          }}}
    ...
    //detectando a area do botao continuar
      if (mouseX >= x1 && mouseX <= x1 + 180 && mouseY >= 260 && mouseY <= 260 + altura1) {
        ...
        if (mouseIsPressed) {
           if(fase==1 ){tela=5 
                controledomouse = true } 
        else if(fase==2 ){tela=6
                controledomouse = true }
        else if(fase==3 ){tela=7
                controledomouse = true }
           else if(fase==4 ){tela=8 
                controledomouse = true }
           else if(fase==5 ){tela=9
                controledomouse = true }
           else if(fase==5+1 ){tela=10 
                controledomouse = true }
           else if(fase==5+2 ){tela=11 
                controledomouse = true }
           else if(fase==5+3 ){tela=12 
                controledomouse = true }
           else if(fase==5+4 ){tela=12+1 
                controledomouse = true }
